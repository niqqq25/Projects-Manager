...
async function create({ project, parentTask, task }) {
...
async function addAssignee(taskId, assignee) {
    try {
...
async function removeAssigne(taskId) {
    try {
        const response = await fetch(
            `${PROTOCOL}${HOSTNAME}/tasks/${taskId}/assignee`,
            {
...
export default { get, create, update, remove, addAssignee, removeAssigne };
